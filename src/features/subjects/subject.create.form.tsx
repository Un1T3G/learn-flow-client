...
import { subjectKeys, useSubjectCreateMutation } from 'entities/subjects'
...
export const SubjectCreateForm = ({ onSuccess }: IProps) => {
  ...
  const { mutate, isPending } = useSubjectCreateMutation({
    onSuccess: () => {
