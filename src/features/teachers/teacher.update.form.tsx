...
import { teacherKeys, useTeacherUpdateMutation } from 'entities/teachers'
...
export const TeacherUpdateForm = ({ id, initialValues, onSuccess }: IProps) => {
  ...
  const { mutate, isPending } = useTeacherUpdateMutation(id, {
    onSuccess: () => {
