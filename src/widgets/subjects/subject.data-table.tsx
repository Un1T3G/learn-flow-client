...
import { useSubjectsQuery } from 'entities/subjects'
...
interface IProps {
  ...
  renderUpdateButton: (id: string, initialValues: SubjectDto) => ReactNode
}
...
export const SubjectDataTable = ({
  ...
  const { data, isLoading, isError, error } = useSubjectsQuery({
    page,
